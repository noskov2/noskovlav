...
const METRICS: MetricDef[] = [
  ...
  { key: 'motorinaValue', label: 'din care: Motorină', get: (r) => r.fuelBreakdown.motorina.value, format: formatLei, sub: true },
  { key: 'benzinaValue', label: 'din care: Benzină', get: (r) => r.fuelBreakdown.benzina.value, format: formatLei, sub: true },
  { key: 'gplValue', label: 'din care: GPL', get: (r) => r.fuelBreakdown.gpl.value, format: formatLei, sub: true },
  { key: 'totalLiters', label: 'Litri combustibil', get: (r) => r.summary.totalLiters, format: (v) => formatNumber(v) },
  { key: 'motorinaLiters', label: 'din care: Motorină', get: (r) => r.fuelBreakdown.motorina.quantity, format: (v) => `${formatNumber(v)} L`, sub: true },
  { key: 'benzinaLiters', label: 'din care: Benzină', get: (r) => r.fuelBreakdown.benzina.quantity, format: (v) => `${formatNumber(v)} L`, sub: true },
  { key: 'gplLiters', label: 'din care: GPL', get: (r) => r.fuelBreakdown.gpl.quantity, format: (v) => `${formatNumber(v)} L`, sub: true },
