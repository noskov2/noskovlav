  ...
  return (
    <div className="flex h-screen overflow-hidden bg-slate-50 text-slate-900">
      ...
      <div className="flex min-w-0 flex-1 flex-col overflow-hidden">
        <header className="no-print flex items-center gap-3 border-b border-slate-200 bg-white px-4 py-3 md:justify-end md:px-8">
          <button
        ...
        {loaded && pendingReports.length > 0 && (
          <div className="no-print flex items-center gap-3 border-b border-warn/20 bg-warn/10 px-4 py-2 text-sm text-warn md:px-8">
